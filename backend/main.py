...
# Import routes
from app.routes import auth_routes, chat_routes, voice_routes, voice_realtime_v2, ocr_routes, loan_routes, report_routes, manager_routes, otp_routes, notification_routes, user_notification_routes
